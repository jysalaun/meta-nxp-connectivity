...
SRC_URI += "file://IW612-Q1-25-R3-p23.13/sduart_nw61x_v1.bin.se"
SRC_URI += "file://IW612-Q1-25-R3-p23.13/sd_w61x_v1.bin.se"
SRC_URI += "file://IW612-Q1-25-R3-p23.13/uartspi_n61x_v1.bin.se"

SRC_URI += "file://IW610-Q1-25-RC3-p54/sd_iw610.bin.se"
SRC_URI += "file://IW610-Q1-25-RC3-p54/sduart_iw610.bin.se"
SRC_URI += "file://IW610-Q1-25-RC3-p54/uart_iw610_bt.bin.se"
SRC_URI += "file://IW610-Q1-25-RC3-p54/uartspi_iw610.bin.se"
SRC_URI += "file://IW610-Q1-25-RC3-p54/sduartspi_iw610.bin.se"
SRC_URI += "file://0001-Add-IW610-15.4-firmware-calibration-file-and-use-it-.patch"

do_install:prepend() {
    rm -f ${S}/nxp/FwImage_IW612_SD/*.se
    cp ${UNPACKDIR}/IW612-Q1-25-R3-p23.13/sduart_nw61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD
    cp ${UNPACKDIR}/IW612-Q1-25-R3-p23.13/sd_w61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD
    cp ${UNPACKDIR}/IW612-Q1-25-R3-p23.13/uartspi_n61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD

    rm -f ${S}/nxp/FwImage_IW610_SD/*.se
    cp ${UNPACKDIR}/IW610-Q1-25-RC3-p54/sd_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC3-p54/sduart_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC3-p54/uart_iw610_bt.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC3-p54/uartspi_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC3-p54/sduartspi_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
}
