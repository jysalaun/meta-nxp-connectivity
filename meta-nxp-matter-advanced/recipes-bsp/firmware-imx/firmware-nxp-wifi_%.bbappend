...
do_install:prepend() {
    ...
    cp ${UNPACKDIR}/IW612-Q1-25-RC3-p23.7/sduart_nw61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD
    cp ${UNPACKDIR}/IW612-Q1-25-RC3-p23.7/sd_w61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD
    cp ${UNPACKDIR}/IW612-Q1-25-RC3-p23.7/uartspi_n61x_v1.bin.se ${S}/nxp/FwImage_IW612_SD

    rm -f ${S}/nxp/FwImage_IW610_SD/*.se
    cp ${UNPACKDIR}/IW610-Q1-25-RC2-p51/sd_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC2-p51/sduart_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC2-p51/uart_iw610_bt.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC2-p51/uartspi_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
    cp ${UNPACKDIR}/IW610-Q1-25-RC2-p51/sduartspi_iw610.bin.se ${S}/nxp/FwImage_IW610_SD
}
